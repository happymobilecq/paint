/*
  ...
  $Id: i18n.c,v 1.127 2014/08/14 06:08:48 perepujal Exp $
...
printf ("Locale AFTER is: %s\n", setlocale(LC_ALL,NULL));//EP
...
#if defined(_WIN32) || (__GLIBC__ == 2 && __GLIBC_MINOR__ >= 2) || __GLIBC__ > 2 || defined(__NetBSD__) || __MACOSX__
  ...
  loc = setlocale(LC_MESSAGES, NULL);
    ...
    loc = strdup(getCurrentLanguage());
#ifdef TUX_LANG_ZH_CN
    textdomain("zh_CN");
    mysetenv("LANGUAGE", "zh_CN");
#else
    textdomain("en_GB");
    mysetenv("LANGUAGE", "en_GB");
#endif
#endif
